...
export const MetricItem = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative z-10 transition-transform duration-500 group-hover/metric:scale-110">{icon}</div>
      ...
      <div className="flex flex-col min-w-0">
        <div className="flex items-center gap-2">
          <span className={cn("font-bold text-gray-900 tracking-tighter tabular-nums leading-none", compact ? "text-md" : "text-lg")}>
            {displayValue}
