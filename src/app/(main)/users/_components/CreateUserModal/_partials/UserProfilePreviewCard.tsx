...
import { Building2, Camera, Check, Clock, KeyRound, Mail, Phone, Plus, Shield, Verified, X } from "lucide-react";
        ...
        <div className="w-full flex flex-col items-center">
          <div className="relative mt-2">
            ...
            <div
              ...
              className="w-32 h-32 relative overflow-hidden rounded-4xl border-4 border-white shadow-xl bg-linear-to-br from-gray-100 to-orange-100/40 mb-4 group cursor-pointer flex items-center justify-center ring-4 ring-orange-500/10 hover:ring-orange-500/30 transition-all duration-300 isolate"
