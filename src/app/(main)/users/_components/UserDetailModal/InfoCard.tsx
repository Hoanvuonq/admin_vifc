...
export const InfoCard = ({ label, value, icon: Icon, color = "orange", className = "", suggestion }: any) => {
  ...
  return (
    <div
      className={cn(
        "group relative p-4 rounded-2xl border border-slate-100 bg-white shadow-sm hover:shadow-xl hover:border-orange-200 transition-all duration-500 overflow-hidden",
    ...
    >
      ...
      <div className="flex items-center gap-4 relative z-10">
        <div
          className={cn(
            "p-2.5 rounded-xl text-white shadow-lg transition-all duration-300 group-hover:scale-110",
        ...
        <div className="flex flex-col min-w-0 flex-1">
          <span className="text-[10px] font-bold uppercase text-gray-600 mb-0.5 whitespace-nowrap">{label}</span>
