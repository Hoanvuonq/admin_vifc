...
export const SEOSection: React.FC = () => {
  const { title, summary, slug, seoTitle, setSeoTitle, seoDescription, setSeoDescription, seoKeywords, setSeoKeywords, setActiveInput } =
    useArticleEditorStore();

  return (
    <div id="form-section-seo" className="bg-white rounded-2xl p-4 shadow-3xs space-y-3" onFocusCapture={() => setActiveInput("seoTitle")}>
      <SectionHeader icon={Globe} title="SEO Optimization" description="SEO Optimization" size="sm" className="pb-2 border-b border-gray-100" />
