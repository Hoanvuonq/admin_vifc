...
export const Layout5: React.FC<LayoutProps> = ({
  title,
  category,
  thumbnail,
  summary,
  ...
  <div className="max-w-200 mx-auto bg-white min-h-screen shadow-xs rounded-2xl overflow-hidden">
    <div className="relative w-full overflow-hidden">
      <BannerImage thumbnail={thumbnail} title={title} aspectClass="aspect-[21/9] md:aspect-[16/7]" />
    </div>
    <div className="relative z-10 -mt-16 md:-mt-24 mx-6 md:mx-12 p-6 md:p-8 bg-white/95 backdrop-blur-md rounded-2xl border border-slate-150 shadow-xl space-y-4">
