      ...
      return renderWrapper(
        <div className="w-full relative group">
          <MediaUploadField
            ...
            classNameSizeUpload={`w-full h-80 rounded-2xl transition-all duration-300 flex flex-col items-center justify-center ${thumbnail ? "bg-transparent border-0" : "bg-slate-50 border-2 border-dashed border-slate-200 hover:border-orange-300 hover:bg-orange-50/50"}`}
          />
        </div>,
        "mt-4 mb-8",
      );
      ...
      return renderWrapper(
        <div className="w-full relative group">
          <MediaUploadField
            ...
            isBanner={true}
            className="w-full relative z-10"
            classNameSizeUpload={`w-full h-64 rounded-2xl transition-all duration-300 flex flex-col items-center justify-center ${block.content ? "bg-transparent border-0" : "bg-slate-50 border-2 border-dashed border-slate-200 hover:border-blue-300 hover:bg-blue-50/50"}`}
          />
        </div>,
        "mt-4 mb-8",
      );
      ...
      return renderWrapper(
        <div className="flex flex-col gap-5 w-full items-center">
          <div className="w-[280px] shrink-0">
            <div className="bg-[#3b3b3b] rounded-2xl p-5 w-full mx-auto flex flex-col items-center justify-center relative overflow-hidden shadow-xl border border-[#444]">
              {block.thumbnailUrl ? (
              ...
              <div className="absolute inset-x-0 bottom-12 flex justify-center z-10">
                <a
                  ...
                  className="bg-white hover:bg-slate-50 text-slate-900 px-5 py-2 rounded-full text-[10px] font-extrabold flex items-center gap-1.5 shadow-xl transition-transform hover:scale-105 active:scale-95"
                >
    ...
    <div className="fixed inset-0 z-50 bg-slate-100 flex flex-col animate-in fade-in duration-300">
      ...
      <div className="flex-1 flex overflow-hidden">
        <div className="w-56 shrink-0 h-full border-r border-slate-200 bg-slate-50/30 p-4 flex flex-col gap-2 z-20">
          <div className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2 px-2 mt-2">Insert Blocks</div>
        ...
        <div className="flex-1 overflow-y-auto bg-slate-100/40 custom-scrollbar relative flex flex-col items-center p-8">
          <div className="w-full max-w-5xl bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-slate-200 min-h-[1000px] h-fit shrink-0 flex flex-col overflow-hidden">
            <div className="h-12 bg-slate-50 border-b border-slate-100 flex items-center px-4 shrink-0 justify-between">
              ...
              <div className="text-[10px] font-bold text-slate-400 bg-white px-3 py-1 rounded-md border border-slate-200 shadow-3xs cursor-default"></div>
              <div className="w-16" />
            </div>
