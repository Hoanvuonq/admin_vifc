            ...
            {isPending && (
              <>
                <button
                  ...
                  className="px-4 h-11 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold transition-all shadow-md shadow-emerald-200 flex items-center gap-1.5 cursor-pointer disabled:opacity-50 whitespace-nowrap shrink-0"
                >
                ...
                <button
                  ...
                  className="px-4 h-11 rounded-2xl bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-50 whitespace-nowrap shrink-0"
                >
        ...
        <div className="space-y-3">
          ...
          <div className="p-4 rounded-2xl bg-white border border-gray-200/80 shadow-xs space-y-3 text-xs">
            <div className="flex items-start justify-between gap-2">
              <div>
                <span className="text-gray-400 block text-[10.5px] font-bold uppercase tracking-wider">Tên khóa học / Dịch vụ</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2.5 border-t border-gray-100 text-xs">
              <div>
                <span className="text-gray-400 block text-[10.5px] font-bold uppercase tracking-wider">Mã đơn booking</span>
                <span className="font-mono font-bold text-gray-800 mt-0.5 block">{orderCode}</span>
              </div>

              <div>
                <span className="text-gray-400 block text-[10.5px] font-bold uppercase tracking-wider">Công ty / Đơn vị</span>
                <span className="font-semibold text-gray-700 mt-0.5 block">{registration.company || "Cá nhân"}</span>
              </div>

              <div>
                <span className="text-gray-400 block text-[10.5px] font-bold uppercase tracking-wider">Thời gian gửi</span>
