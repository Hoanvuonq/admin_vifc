...
export const getColumns = (
  ...
  handleDelete: (item: BookingRequestItem) => void
    ...
    },
    {
      ...
      render: (item: BookingRequestItem) => (
        <div className="flex flex-col py-1">
          ...
          <span
            className="font-bold text-[13px] text-gray-800 line-clamp-1 group-hover:text-orange-600 transition-colors max-w-70"
    ...
    },
    {
      ...
      render: (item: BookingRequestItem) => (
        <span className="text-gray-600 font-bold font-mono tracking-tight select-text">
          {item.phone || "--"}
        </span>
      ),
    },
    ...
    },
    {
      ...
      render: (item: BookingRequestItem) => (
        <StatusBadge status={item.status} variant="premium" />
      ),
    },
    {
      header: "Actions",
