  ...
  return (
      ...
      footer={
        <>
          <PremiumButton
            ...
            onClick={() => {}}
            size="sm"
            className="px-6 py-2 rounded-2xl font-bold uppercase text-[9px] tracking-widest"
          />
    ...
    >
      <div className="space-y-4">
        ...
        <div className="bg-orange-50/40 rounded-2xl border border-orange-100/50 p-5 flex justify-between items-center relative shadow-sm">
          ...
          {[
            ...
            <motion.div
              ...
              className={cn(
                ...
                "border-t-2",
                s.border === "emerald" ? "border-t-emerald-500" : s.border === "amber" ? "border-t-amber-500" : "border-t-rose-500",
              )}
            >
              ...
              <div className="flex items-baseline gap-0.5">
                <span className={cn("text-2xl font-bold tabular-nums tracking-tighter leading-none", s.color)}>{s.value}</span>
              ...
              <div className="absolute bottom-3 right-3 w-12 h-6 opacity-30 group-hover:opacity-100 transition-opacity duration-500">
                <svg viewBox="0 0 100 40" className={cn("w-full h-full fill-none stroke-3", s.color)}>
                  <path d={s.path} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </motion.div>
          ))}
